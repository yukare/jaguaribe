...
/**
 * Utilities to work with keyboard
 *
...
public class KeyboardUtils {
    ...
    /**
     * Conversion from a KeyEvent to a KeyStroke.
     *
     * @param evt The KeyEvent from keyboard(a key press).
     * @return A string representing the keystroke(used in shortcuts).
     */
    public static String keyEvent2keyStroke(KeyEvent evt) {
        ...
        if ((m & (InputEvent.BUTTON1_DOWN_MASK | InputEvent.BUTTON1_MASK)) != 0) {
            answer.append("button1 ");
        }
        if ((m & (InputEvent.BUTTON2_DOWN_MASK | InputEvent.BUTTON2_MASK)) != 0) {
            answer.append("button2 ");
        }
        if ((m & (InputEvent.BUTTON3_DOWN_MASK | InputEvent.BUTTON3_MASK)) != 0) {
            answer.append("button3 ");
        }
        answer.append(KeyboardUtils.getKeyText(evt.getKeyCode()));
        return answer.toString();
    }

    /**
     * Conversion from a KeyStroke to a String.
     *
     * @param key Keystroke to convert.
     *
     * @return The string with the description of keystroke.
     */
    ...
    /**
     * Convert a Keycode from a keystroke to a string.
     *
     * @param keyCode The keycode to convert.
     *
     * @return A string with the description of keycode.
     */
